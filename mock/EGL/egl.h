/*
 * EGL Header Stub
 * Provides minimal EGL type definitions for compilation when EGL headers are not available
...
/* EGL Function Declarations (implemented in egl-stubs.c) */
